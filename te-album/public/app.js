...
const state = { photos: [], albums: [], memberships: [], analyses: new Map(), view: "all", selectedAlbum: null, currentPhoto: null, user: null, actor: null };
